...
const SubmitButton = styled.button`
	${tw`flex items-center justify-center w-full py-4 mt-5 font-semibold tracking-wide text-gray-100 transition-all duration-300 ease-in-out rounded-lg disabled:bg-gray-700 disabled:hover:bg-gray-700 bg-primary-500 hover:bg-primary-900 focus:shadow-outline focus:outline-none`}
	.icon {
		${tw`w-6 h-6 -ml-2`}
	}
	.text {
